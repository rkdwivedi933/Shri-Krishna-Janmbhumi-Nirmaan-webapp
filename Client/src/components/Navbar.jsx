...
import Register from "../pages/Register"; // ✅ import Register form instead of Login
...
function Navbar() {
  ...
  useEffect(() => {
    document.body.style.overflow = showRegisterForm ? "hidden" : "";
    ...
    <nav className="bg-blue-900 text-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <button
              onClick={() => setShowRegisterForm(true)} // ✅ Show register form
      ...
      {showRegisterForm && (
        <div
          ...
          aria-modal="true"
          onClick={(e) => {
            if (e.target === e.currentTarget) setShowRegisterForm(false);
          }}
        >
